...
public class PlatosArequipaActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_platos_arequipa);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnRegresarMain:
                ...
                break;
            case R.id.button:
                startActivity(new Intent(this, ArequipaPlato1Activity.class));
                break;
            case R.id.button2:
                startActivity(new Intent(this, ArequipaPlato2Activity.class));
                break;
            case R.id.button3:
                startActivity(new Intent(this, ArequipaPlato3Activity.class));
                break;
        }
    }
}