...
public class PlatosPunoActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_platos_puno);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnRegresarMain:
                ...
                break;
            case R.id.button:
                startActivity(new Intent(this, PunoPlato1Activity.class));
                break;
            case R.id.button2:
                startActivity(new Intent(this, PunoPlato2Activity.class));
                break;
            case R.id.button3:
                startActivity(new Intent(this, PunoPlato3Activity.class));
                break;
        }
    }
}